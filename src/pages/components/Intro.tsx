...
const Intro = () => {
    return (
        <section className="flex flex-col items-center gap-5 pt-25">
            ...
            <div className="text-[#FF8000] text-4xl mb-5 font-bold">About me</div>
            <section className="flex gap-10 h-75 items-start">
                ...
                <section>
                    ...
                    <section className="flex gap-10 py-4">
                        <div className="bg-[#FBD5A5] w-45 h-45 flex flex-col items-start justify-between p-4 rounded-xl text-[#001E29]">
                            <Image
                                src="/darkIcon.jpg"
                                alt="business card"
                                width={30}
                        ...
                        <div className="bg-[#FBD5A5] w-45 h-45 flex flex-col items-start justify-between p-4 rounded-xl text-[#001E29]">
                            ...
                            <div className="font-extralight">Languages</div>
                        </div>                        <div className="bg-[#FBD5A5] w-45 h-45 flex flex-col items-start justify-between p-4 rounded-xl text-[#001E29]">
                            <Image
                                src="/darkIcon.jpg"
                                alt="business card"
                                width={30}
