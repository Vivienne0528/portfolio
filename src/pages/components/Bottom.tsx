        ...
        <section className="flex flex-col items-center gap-2 pt-50 w-full">
            ...
            <section className="flex items-center justify-between w-full mb-10 text-[16px] md:text-xl leading-[1.5rem] md:leading-[1.75rem]">
                ...
                <section className="sm:flex-row flex flex-col gap-8 w-full sm:w-auto mt-5 sm: justify-center items-center sm:justify-between">
                    <div className="cursor-pointer hover:scale-105 transition duration-200 ease-in-out">Github</div>
                    <div className="cursor-pointer hover:scale-105 transition duration-200 ease-in-out">Linkedin</div>
                    <div className="cursor-pointer hover:scale-105 transition duration-200 ease-in-out">Connect with me</div>
                </section>
            </section>
        </section>
    );
