...
const MyService = () => {
    return (
        <section className="flex flex-col items-center gap-5 pt-50 w-full">
            <div>What i offers</div>
            <div className="text-[#FF8000] text-3xl font-[serif]">My Service</div>
            ...
            <section className="flex py-4 gap-10 w-full items-center justify-between">
                <div className="bg-[#808E94] w-60 h-60 flex flex-col items-start justify-between p-4 rounded-xl">
