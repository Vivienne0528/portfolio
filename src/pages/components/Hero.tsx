...
const Hero = () => {
  ...
  return (
    <>
      ...
      />
      <div className="flex flex-col pb-15 md:py-30 text-center justify-center items-center md:text-6xl text-[2.6rem] font-[serif] font-extrabold">
        <p className="bg-gradient-to-r from-amber-500 to-orange-500 bg-clip-text text-transparent ">
