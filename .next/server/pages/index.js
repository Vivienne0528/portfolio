(() => {
  ...
  (e.id = 332),
    ...
    (e.modules = {
      ...
      526: (e, t, s) => {
        "use strict";
        s.r(t), s.d(t, { UseContext: () => a, default: () => n });
        var l = s(8732),
          r = s(2015);
      ...
      1228: (e, t, s) => {
        ...
        var l = s(8732),
          ...
          i = s(2015);
        let o = () => {
          let { aboutRef: e } = (0, i.useContext)(n.useRefStore);
      ...
      1279: (e, t, s) => {
        ...
        s.a(e, async (e, l) => {
          try {
            ...
            let x = (0, n.M)(d, "default"),
              m = (0, n.M)(d, "getStaticProps"),
              u = (0, n.M)(d, "getStaticPaths"),
              h = (0, n.M)(d, "getServerSideProps"),
              g = (0, n.M)(d, "config"),
              p = (0, n.M)(d, "reportWebVitals"),
              f = (0, n.M)(d, "unstable_getStaticProps"),
              b = (0, n.M)(d, "unstable_getStaticPaths"),
              j = (0, n.M)(d, "unstable_getStaticParams"),
              w = (0, n.M)(d, "unstable_getServerProps"),
              v = (0, n.M)(d, "unstable_getServerSideProps"),
              N = new r.PagesRouteModule({
                definition: {
                  kind: a.A.PAGES,
                  page: "/index",
                  pathname: "/",
      ...
      1744: (e, t, s) => {
        ...
        var l = s(8732),
          r = s(2015),
          a = s(4554);
        let n = ["/figma.png", "/socially.png", "/pizza.png", "/portfolio.png"],
          i = () => {
              ...
              children: [
                ...
                (0, l.jsx)("section", {
                  ...
                  children: (0, l.jsxs)("div", {
                    ...
                    children: [
                      (0, l.jsx)("img", { src: n[s], className: "w-full" }),
                      (0, l.jsxs)("div", {
                        className:
                        ...
                        children: [
                          (0, l.jsx)("button", {
                            onClick: () =>
                              i((e) => (e - 1 + n.length) % n.length),
                            className: "btn btn-circle",
                            children: "❮",
                          }),
                          (0, l.jsx)("button", {
                            onClick: () => i((e) => (e + 1) % n.length),
                            className: "btn btn-circle",
                            children: "❯",
                          }),
                        ],
      ...
      2081: (e, t, s) => {
        ...
        var l = s(8732);
        function r({ Component: e, pageProps: t }) {
          return (0, l.jsx)(e, { ...t });
        }
        s(979);
      },
                  ...
                  (0, r.jsxs)(
                    "span",
                    {
                      ...
                      children: [
                        e.map((e, s) => {
                          let l =
                            u.slice(0, t).reduce((e, t) => e + t.length, 0) + s;
                          return (0, r.jsx)(
                            a.animated.span,
                            {
                              style: {
      ...
      2931: (e, t, s) => {
        ...
        var l = s(8732),
          ...
          o = s(4554);
        let d = () => {
          let { scrollToSection: e } = (0, n.useContext)(i.UseContext),
            { heroRef: t } = (0, n.useContext)(o.useRefStore);
          return (0, l.jsxs)("section", {
            ...
            children: [
              ...
              (0, l.jsx)("div", { className: "h-px bg-[#FBD5A5] mt-5 w-full" }),
              (0, l.jsxs)("section", {
                className:
      ...
      5603: (e, t, s) => {
        ...
        var l = s(8732),
          ...
          a = s(526);
        let n = () => {
          let { handleClickMenu: e, checkboxRef: t } = (0, r.useContext)(
            a.UseContext,
          );
          return (0, l.jsxs)("section", {
            ...
            children: [
              ...
              (0, l.jsxs)("label", {
                ...
                children: [
                  (0, l.jsx)("input", { type: "checkbox", ref: t }),
                  (0, l.jsx)("svg", {
                    onClick: e,
        ...
        s.a(e, async (e, l) => {
          try {
            ...
            var r = s(8732),
              ...
              x = s.n(c),
              m = e([o, d]);
            [o, d] = m.then ? (await m)() : m;
            let u = () => {
              let { contactRef: e } = (0, a.useContext)(n.useRefStore),
                {
                  schema: t,
                  messageSubmit: s,
                  successMessage: l,
                ...
                } = (0, i.useAuth)(),
                {
                  ...
                  handleSubmit: j,
                  formState: { errors: w },
                } = (0, d.useForm)({ resolver: (0, o.yupResolver)(t) });
              return (
                (0, a.useEffect)(() => {
                  h || c("");
                }),
                    ...
                    (0, r.jsxs)("form", {
                      ...
                      children: [
                        ...
                        (0, r.jsx)("textarea", {
                          ...
                          ...b("message", { required: !0 }),
                        }),
                        (0, r.jsxs)("div", {
                          className:
                            "text-red-600 font-extrabold text-[14px] flex flex-col justify-center items-center",
                          children: [
                            (0, r.jsx)("p", { children: w.name?.message }),
                            (0, r.jsx)("p", { children: w.email?.message }),
                            (0, r.jsx)("p", { children: w.message?.message }),
                            l &&
                              (0, r.jsx)("p", {
                                className: "text-green-600",
                                children: l,
                              }),
                            m && (0, r.jsx)("p", { children: m }),
                            !h &&
                              (0, r.jsx)("p", {
                                children:
                                  " Please complete the CAPTCHA verification.",
                              }),
                            g && (0, r.jsx)("p", { children: p }),
                          ],
                        }),
                        (0, r.jsx)("button", {
                          disabled: !h || g,
      ...
      6647: (e, t, s) => {
        ...
        let r = require("yup"),
          a = () => {
            ...
            return {
              messageSubmit: async ({ name: e, email: s, message: l }) => {
                if ((u(30), o))
                  return void x(
                ...
                try {
                  if (
                    (
                      await fetch("/api/contact", {
                        ...
                        body: JSON.stringify({ name: e, email: s, message: l }),
                      })
                    ).ok
                  ) {
                    d(!0);
                  ...
                  console.log(e),
                    a("❌ Failed to send message. Please try again later."),
                    t("");
                }
              },
              schema: r
                ...
                .shape({
                  ...
                  name: r.string().required("Please enter your name."),
                  message: r.string().required("Please enter your message."),
                })
                .required(),
              successMessage: e,
              errorMessage: s,
      ...
      9118: (e, t, s) => {
        ...
        let o = () => {
          let {
              ...
              activeSection: s,
              scrollToSection: o,
            } = (0, r.useContext)(a.UseContext),
            {
              heroRef: d,
              projectRef: c,
              contactRef: x,
              aboutRef: m,
            } = (0, r.useContext)(i.useRefStore);
      ...
      `,
          ...
          ${"hero" === s ? "bg-[#FBD5A5] font-bold text-[#FF8000]" : ""}`,
                      children: "Home",
                    }),
                    (0, l.jsx)("li", {
                      onClick: () => o("about", m),
                      className: `cursor-pointer w-full  rounded-full text-center hover:text-[#ff7300] hover:scale-105 hover:font-bold transition duration-300 ease-in-out
          ${"about" === s ? "bg-[#FBD5A5] font-bold text-[#FF8000] " : ""}`,
                      children: "About me",
                    }),
                    (0, l.jsx)("li", {
                      onClick: () => o("project", c),
                      className: `cursor-pointer w-full  rounded-full text-center hover:text-[#ff7300] hover:scale-105 hover:font-bold transition duration-300 ease-in-out
          ${"project" === s ? "bg-[#FBD5A5] font-bold text-[#FF8000]" : ""}`,
                      children: "My work",
                    }),
                    (0, l.jsx)("li", {
                      onClick: () => o("contact", x),
                      className: `cursor-pointer w-full  rounded-full text-center hover:text-[#ff7300] hover:scale-105 hover:font-bold transition duration-300 ease-in-out
          ${"contact" === s ? "bg-[#FBD5A5] font-bold text-[#FF8000]" : ""}`,
                      children: "Contact me",
                    }),
                  ],
                }),
