          ...
          if (("TURBOPACK compile-time truthy", 1)) {
            (function () {
                  ...
                  if (isArray(mappedChild)) {
                    ...
                    if (isValidElement(mappedChild)) {
                      ...
                      mappedChild = cloneAndReplaceKey(
                        ...
                        escapedPrefix +
                          (mappedChild.key &&
                          (!_child || _child.key !== mappedChild.key) // eslint-disable-next-line react-internal/safe-string-coercion
              ...
              function disableLogs() {
                {
                  if (disabledDepth === 0) {
                    /* eslint-disable react-internal/no-production-logging */ prevLog =
                      console.log;
